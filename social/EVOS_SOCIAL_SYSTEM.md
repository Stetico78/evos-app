...
Bio:
`AI + profesionales para convertir objetivos en acciones.`
`Evolución física, mental y emocional.`
`Personas + profesionales ↓`

CTA: `/landing?utm_source=instagram&utm_medium=bio&utm_campaign=evos_main`

Pinned content:
1. Qué es EVOS en 20 segundos.
...
- 09:00 educational Reel
- 10:00 poll or diagnostic Story
- 11:00 EVOS feature / workflow
- 12:00 professional spotlight or invitation
- 13:00 relatable problem / entertainment
- 14:00 practical micro-action
- 15:00 founder / behind-the-scenes
...
Generate every hour, but do not publish 24 feed posts per day. Use Stories and lightweight interactions for high-frequency activity; reserve feed/Reels for the strongest pieces.

## Content pillars
1. EVOS explained simply.
2. Problems EVOS reduces: overload, lack of direction, fragmented services.
3. EVOS AI guidance and next actions.
...
- Use the EVOS landing page instead of several unrelated links.
- Add UTM parameters by profile and campaign.
- Do not promise guaranteed health, financial or therapeutic outcomes.
- Do not spam the feed hourly.
- Keep visual language: dark premium base, warm gold/orange light, whitespace, simple typography, one focal element.

## Success metrics
Track weekly by source:
- profile visits
- link clicks
- landing leads
- EVOS account creations
- completed assessments
- booking starts/completions
- professional applications

## Current limitation
Direct Instagram/Meta publishing is not connected in the current ChatGPT environment. Until a supported connection is available, the automation generates publication-ready assets and this repository stores the operating system; actual Instagram profile edits and publishing require access through Instagram/Meta itself.
